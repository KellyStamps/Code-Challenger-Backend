...
challenge_arr.each do |chall|
  Challenge.create(content: chall, rating: 10, links: 'https://developer.mozilla.org/en-US/docs/Web, https://developer.mozilla.org/en-US/docs/Web, https://developer.mozilla.org/en-US/docs/Web')
end
